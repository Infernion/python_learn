...
Для работы с table_ (обновления, с отметкой о сделаном задании) добавьте после номера-ссылки плюсик "+" (так вы дадите понять, что решение готово и лежит в вашем репозитарии) и убедитесь в работе уже прописаной ссылки. Предполагаеться использование ветки "solutions" для решений. Когда гуру заметит, он поставит "✓" напротив. 
